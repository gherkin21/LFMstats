...
\begin{DoxyCompactList}\small\item\em Asynchronously loads scrobbles for a specific user within a given UTC date range. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Asynchronously loads all stored scrobbles for a specific user. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Checks if there are pending save operations either running or queued. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Asynchronously loads all stored scrobbles for a specific user. 

Only one load operation can be active at a time. Results are emitted via load\+Complete or load\+Error signals. 
\begin{DoxyParams}{Parameters}
...
Asynchronously loads scrobbles for a specific user within a given UTC date range. 
