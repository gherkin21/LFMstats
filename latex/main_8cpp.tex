...
Main entry point for the Last.\+fm Scrobble Analyzer application.  
...
Initializes the QApplication, creates the main \doxylink{class_main_window}{Main\+Window} instance, shows the window, and starts the application event loop. 
